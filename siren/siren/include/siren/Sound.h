...
namespace siren {
	...
	private:
		...
		Sound(SoundType type, const std::string& tag);
	...
	public:
		...
		/// @param path Path to the file
		/// @return Sound object
		static Sound Stream(const std::string& path, const std::string& tag="");

		/// @brief Constructs a sound object that loads an audio file into memory (ownership)
		/// @param path Path to the file to be loaded
		/// @return Sound object
		static Sound Internal(const std::string& path, const std::string& tag="");

		/// @brief Constructs a sound object with a view of a sound file loaded into memory
		/// (non-ownership)
		/// @param externalData Sound file in memory
		/// @return Sound object
		static Sound External(std::span<const std::byte> externalData, const std::string& tag="External_memory");
		...
		/// @return The tag given to the sound
